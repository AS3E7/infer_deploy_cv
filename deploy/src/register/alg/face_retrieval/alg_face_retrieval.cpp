...
int AlgFaceRetrieval::Init(std::string config, ModelPtr model)
{
    model_ = model;
    return 0;
}

int AlgFaceRetrieval::CreateProcessor(std::vector<ProcessorPtr> &processors)
{
