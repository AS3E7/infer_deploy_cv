...
int AlgImageRetrieval::Init(std::string config, ModelPtr model)
{
    model_ = model;
    return 0;
}

int AlgImageRetrieval::CreateProcessor(std::vector<ProcessorPtr> &processors)
{
