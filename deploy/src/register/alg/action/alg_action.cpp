...
int AlgAction::Init(std::string config, ModelPtr model)
{
    model_ = model;
    return 0;
}

int AlgAction::CreateProcessor(std::vector<ProcessorPtr> &processors)
{
    ...
    PreProcCreator* preproc_creator = preprocmgr->GetPreProcCreator("any", "cpu");
