...
#include "device_monitor/bm1684_device_monitor.hpp"
#include "device_monitor/intel_device_monitor.hpp"
#include "device_monitor/jetson_device_monitor.hpp"
#include "device_monitor/mlu2xx_device_monitor.hpp"
#include "device_monitor/nvidia_device_monitor.hpp"
#include "device_monitor/rv1126_device_monitor.hpp"
...
private:
    ...
    int _device_info(const HttpContextPtr &ctx) {
        ...
        for (uint32_t i = 0; i < dev_count; i++) {
            ...
            item["chip_name"] = moniter_->get_chip_name();
