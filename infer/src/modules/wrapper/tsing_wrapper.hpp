...
static int tsmpp_init() {
    VB_CONFIG_S stVbConfig;
    TS_S32 s32Ret = TS_SUCCESS;

    SIZE_S stDispSize{1920, 1080};

    memset(&stVbConfig, 0, sizeof(VB_CONFIG_S));
    stVbConfig.u32MaxPoolCnt = 1;
    stVbConfig.astCommPool[0].u32BlkCnt = 50 * 1;
    stVbConfig.astCommPool[0].u64BlkSize =
        COMMON_GetPicBufferSize(1920, 1080, PIXEL_FORMAT_YVU_PLANAR_420, DATA_BITWIDTH_8, COMPRESS_MODE_SEG, 0);
    TS_MPI_SYS_Exit();
    TS_MPI_VB_Exit();
