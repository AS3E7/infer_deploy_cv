...
enum class Position { kCenter, kTop, kRight, kBottom, kLeft };
...
public:
     ...
     * @return false 
     */
    bool init_border(const Position &position, const std::vector<std::vector<Point2i>> &borders, const int margin = 0);
