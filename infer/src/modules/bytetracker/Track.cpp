...
unordered_map<int, int> Track::static_track_id_dict;  // �ྲ̬��Ա��������


Track::Track(const vector<float>& tlwh_, const float& score, const int& cls_id, const int& box_id)
{
	_tlwh.resize(4);
